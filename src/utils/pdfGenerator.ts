...
export async function generateBookingPDF(data: BookingPDFData): Promise<void> {
  ...
  if (data.philippinesIdFront) {
    ...
    doc.setFont('helvetica', 'bold')
    doc.setTextColor(0, 0, 0)
      doc.text('Philippines ID - Front', leftImageX, bottomRowY - 16)
    } else {
      doc.setPage(page3Number)
      doc.setFontSize(9)
      doc.setFont('helvetica', 'bold')
      doc.setTextColor(128, 128, 128)
      doc.text('Philippines ID - Front (Not Provided)', leftImageX, bottomRowY - 16)
  }
  ...
  if (data.philippinesIdBack) {
    ...
    doc.setFont('helvetica', 'bold')
    doc.setTextColor(0, 0, 0)
      doc.text('Philippines ID - Back', rightImageX, bottomRowY - 16)
    } else {
      doc.setPage(page3Number)
      doc.setFontSize(9)
      doc.setFont('helvetica', 'bold')
      doc.setTextColor(128, 128, 128)
      doc.text('Philippines ID - Back (Not Provided)', rightImageX, bottomRowY - 16)
  }
